...
.. **Create worktree from origin/dev**:
   ...
   git worktree add ../gitest-wt/fix-atlas-worktree-path-crash origin/dev
   ```
2. **Create feature branch**:
   ```bash
   cd ../gitest-wt/fix-atlas-worktree-path-crash
...
git worktree remove ../gitest-wt/fix-atlas-worktree-path-crash
```
