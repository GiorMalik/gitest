...
.. Create worktree from `origin/dev`:
   ...
   git worktree add ../gitest-wt/fix/comment-checker-note-false-positive origin/dev
   cd ../gitest-wt/fix/comment-checker-note-false-positive
...
**B. This repo (gitest)** - the PR scope:
...
# Cleanup worktree
cd <repo-root>
git worktree remove ../gitest-wt/fix/comment-checker-note-false-positive
```
